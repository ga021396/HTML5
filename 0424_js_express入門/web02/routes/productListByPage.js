...
router.get('/', function(req, res, next) {
    ...
    pool.query('select count(*) as cnt from product', function(err, results) {
        ...
        pool.query('SELECT a.proNo, a.proName, a.supNo, b.supName from product a, supplier b where  a.supNo=b.supNo limit ?,?',[(pageNo-1)*linePerPage, linePerPage], function(err, results) {
            if (err) {
